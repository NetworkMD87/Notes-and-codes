...
const api: Api = {
  ...
  loadRecentFolders: () => ipcRenderer.invoke('recentFolders:load'),
  addRecentFolder: (path) => ipcRenderer.invoke('recentFolders:add', path),
  removeRecentFolder: (path) => ipcRenderer.invoke('recentFolders:remove', path),
