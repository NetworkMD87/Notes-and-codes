...
// Marker paths lifted from ICONS.highlighter (toolbar.ts) so the cursor and the button are the
// same object. HEAD_D is the tip; it gets filled with the active colour, the rest stays outline.
