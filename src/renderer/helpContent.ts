...
export const HELP_SECTIONS: HelpCategory[] = [
  ...
  { title: 'Tools', entries: [
    ...
    { label: 'Markdown: Heading', desc: 'Turn the current line or selection into a heading.' },
    { label: 'Markdown: Bold', desc: 'Make selected text bold.' },
    { label: 'Markdown: Italic', desc: 'Make selected text italic.' },
    { label: 'Markdown: Link', desc: 'Turn selected text into a web link.' },
    { label: 'Markdown: Inline code', desc: 'Mark selected text as a short code sample.' },
    { label: 'Markdown: Code block', desc: 'Put the current line or selection in a fenced code block.' },
    { label: 'Markdown: Quote', desc: 'Mark the current line or selection as a quote.' },
    { label: 'Markdown: Bulleted list', desc: 'Add or remove bullet markers on the selected lines.' },
    { label: 'Markdown: Numbered list', desc: 'Add or remove sequential number markers on the selected lines.' },
    { label: 'Markdown: Task list', desc: 'Add or remove unchecked task markers on the selected lines.' },
  ] },
